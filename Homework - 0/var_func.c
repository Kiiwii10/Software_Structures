...
enum { MIN_ELEMENT = 1, MAX_ELEMENT = 1000000 };

/**
 * @brief Calculate sum of <count> elements
 * @param count Number of elements to sum
 * @param ... Elements to sum
...
/**
 * @brief Find minimum of <count> elements
 * @param count Number of elements to find minimum of
 * @param ... Elements to find minimum of
 * @return Min element
 */
int m_min(int count,...) {
    va_list args;
...
/**
 * @brief Find maximum of <count> elements
 * @param count Number of elements to find maximum of
 * @param ... Elements to find maximum of
 * @return Max element
 */
int m_max(int count,...) {
    va_list(args);
